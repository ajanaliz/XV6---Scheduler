...
main(void)
{
  ...
  waittest();
  11:	e8 2a 00 00 00       	call   40 <waittest>
  exit();
  16:	e8 d7 02 00 00       	call   2f2 <exit>
  1b:	66 90                	xchg   %ax,%ax
  1d:	66 90                	xchg   %ax,%ax
  1f:	90                   	nop
...
foo()
{
  ...
  sleep(20);
  26:	6a 14                	push   $0x14
  28:	e8 55 03 00 00       	call   382 <sleep>
  for (i=0;i<100;i++);
    // printf(2, "wait test %d\n",i);
  ...
  30:	c9                   	leave  
  31:	c3                   	ret    
  32:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
waittest(void)
{
  ...
  43:	83 ec 20             	sub    $0x20,%esp
  int wTime;
  int rTime;
  int pid;
  printf(1, "wait test\n");
  46:	68 70 07 00 00       	push   $0x770
  4b:	6a 01                	push   $0x1
  4d:	e8 fe 03 00 00       	call   450 <printf>


    pid = fork();
  52:	e8 93 02 00 00       	call   2ea <fork>
    if(pid == 0)
  57:	83 c4 10             	add    $0x10,%esp
  5a:	85 c0                	test   %eax,%eax
  5c:	74 35                	je     93 <waittest+0x53>
    {
      foo();
      exit();      
    }
    getppid(&wTime,&rTime);
  5e:	8d 45 f4             	lea    -0xc(%ebp),%eax
  61:	83 ec 08             	sub    $0x8,%esp
  64:	50                   	push   %eax
  65:	8d 45 f0             	lea    -0x10(%ebp),%eax
  68:	50                   	push   %eax
  69:	e8 24 03 00 00       	call   392 <getppid>
     printf(1, "hi \n");
  6e:	58                   	pop    %eax
  6f:	5a                   	pop    %edx
  70:	68 7b 07 00 00       	push   $0x77b
  75:	6a 01                	push   $0x1
  77:	e8 d4 03 00 00       	call   450 <printf>
    printf(1, "wTime: %d rTime: %d \n",wTime,rTime);
  7c:	ff 75 f4             	pushl  -0xc(%ebp)
  7f:	ff 75 f0             	pushl  -0x10(%ebp)
  82:	68 80 07 00 00       	push   $0x780
  87:	6a 01                	push   $0x1
...
foo()
{
  ...
  96:	6a 14                	push   $0x14
  98:	e8 e5 02 00 00       	call   382 <sleep>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3ef:	f7 f6                	div    %esi
 3f1:	0f b6 92 a0 07 00 00 	movzbl 0x7a0(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 568:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 56b:	b8 96 07 00 00       	mov    $0x796,%eax
...
free(void *ap)
{
 ...
 647:	89 08                	mov    %ecx,(%eax)
  freep = p;
 649:	a3 7c 0a 00 00       	mov    %eax,0xa7c
}
 64e:	5b                   	pop    %ebx
 64f:	5e                   	pop    %esi
 650:	5f                   	pop    %edi
 ...
 66a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 66d:	a3 7c 0a 00 00       	mov    %eax,0xa7c
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 689:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 68c:	8b 15 7c 0a 00 00    	mov    0xa7c,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 72c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 72f:	89 15 7c 0a 00 00    	mov    %edx,0xa7c
      return (void*)(p + 1);
 ...
 744:	eb e9                	jmp    72f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 746:	c7 05 7c 0a 00 00 80 	movl   $0xa80,0xa7c
 74d:	0a 00 00 
 750:	c7 05 80 0a 00 00 80 	movl   $0xa80,0xa80
 757:	0a 00 00 
    base.s.size = 0;
 75a:	b8 80 0a 00 00       	mov    $0xa80,%eax
 75f:	c7 05 84 0a 00 00 00 	movl   $0x0,0xa84
 766:	00 00 00 
